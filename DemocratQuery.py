...
# enter
dpath = ' ' # for location of csv file
...
x = 1000  # amount of searches/items; there is a function to handle Twitter's rate limit  
    ...
    for tweets in tweepy.Cursor(api.search, q=candidate).items(x):
        ...
        if ', NC' in grouping or 'North Carolina' in grouping:
            ...
            if 'Trump' in tweets.text:
                trump_count += 1 # see print statement
...
def run_without_limit(candidates):
